...
public class DatabaseInstruments {
    ...
    DBHelper dbHelper;
    SQLiteDatabase DB;
    final int CURRENT_DATABASE_VERSION = 5;
...
//TODO: insert if name not contained
    ...
    public void insertBasicRecipes() {
        ...
        insertRecipe("Пицца по-студенчески",
                ...
                "Тесто,Сосиски,Соус,Грибы,Огурец,Лук,Сыр", "http://kulinar-student.blogspot.ru/p/blog-page_8793.html", "Пицца"
        );
        insertRecipe("Быстрый суп гороховый",
                ...
                "Тушёнка,Горошек,Картофель,Морковь,Лук,Зелень,Специи", "http://food.passion.ru/retsept-dnya-c-foto/pervye-blyuda/bystryi-sup-gorokhovyi.htm",
                "Суп");
        ...
        insertRecipe("Жареные пельмени в яйцах", "Очистить луковицу, нашинковать полукольцами. Нагреть масло, обжарить лук до розового цвета. " +
                ...
                "http://recipebox.ru/bliuda-iz-polufabrikatov/bliuda-iz-pelmeney-11-vkusnich-retseptov.html", "Второе");
        ...
        insertRecipe("Баклажаны тушёные",
                ...
                "Баклажаны, лук, яблоки, помидоры - всё для любителей овощей и фруктов! На первый взгляд кажется, что сложно, но раз сделала и рука набита! Пробуйте...",
                "Баклажан,Лук,Яблоко,Помидор,Сахар,Масло",
                "http://studportal.net.ua/page.php?al=baklazhany_tushenye", "Второе");
        insertRecipe("Макаронная запеканка с яйцом",
                ...
                "Макароны,Сосиски,Сыр,Яйца,Сметана,Масло,Соль", "http://studikam.ru/kak-pitatsya-nedorogo-i-interesno-studentu", "Запеканка");
        insertRecipe("Постные гречневые котлеты", "Отварить гречневую кашу в слабо подсоленной воде.\n" +
                ...
                "http://studikam.ru/kak-pitatsya-nedorogo-i-interesno-studentu", "Котлеты");
    }
